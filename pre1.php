...
<head>
    ...
    <link rel="stylesheet" href="css/precom.css">
...
<body>
    ...
    <section id="precommande">
        ...
        <section id="pre-top" class="myscroll">
            ...
            <img src="image/precom/last.png" id="image-pre-top">
        ...
        <section id="mid" class="myscroll">
            ...
            <img src="image/precom/ellie.png" id="mid-img">

            <div class="row" style="width:100%">
                <div class="col-md-6"></div>
                <div class="col-md-6">
                    <div id="mid-text" style="margin-top: -30px;">
                        <h1 class="myh1" style="font-family: 'Pacifico', cursive;">Présentation</h1>
                        <br>
                        <p style="font-weight: bold;font-size: 16px;">Cinq ans après leur voyage périlleux à travers une Amérique ravagée par une pandémie, Ellie et Joel ont trouvé refuge à Jackson, dans le Wyoming. Vivre dans une communauté florissante de survivants leur a permis de connaître la
                            paix et la stabilité en dépit de la menace constante des infectés et des survivants désespérés. </p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="gallery-section">
                <div class="inner-width">
                    ...
                    <div class="gallery">
                        ...
                        <a href="image/precom/1.png" class="image">
                            <img src="image/precom/1.png" alt="">
                        </a>

                        <a href="image/precom/2.png" class="image">
                            <img src="image/precom/2.png" alt="">
                        </a>

                        <a href="image/precom/3.png" class="image">
                            <img src="image/precom/3.png" alt="">
                        </a>

                        <a href="image/precom/4.png" class="image">
                            <img src="image/precom/4.png" alt="">
                        </a>

                        <a href="image/precom/5.png" class="image">
                            <img src="image/precom/5.png" alt="">
                        </a>

                        <a href="image/precom/6.png" class="image">
                            <img src="image/precom/6.png" alt="">
                        </a>

                        <a href="image/precom/7.png" class="image">
                            <img src="image/precom/7.png" alt="">
                        </a>

                        <a href="image/precom/8.png" class="image">
                            <img src="image/precom/8.png" alt="">
                        </a>
        ...
        <section id="pre-bot">
            <img src="image/precom/bot.png">
        </section>


        <section id="bot" class="myscroll">

            <h1 style="text-align: center; color:#164094; font-weight:bold; font-size:40px; margin-bottom:30px">Embarquez pour l'aventure d'Ellie </h1>
            <div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active std" id="tab1">
                        <div class="row" class="width:90%">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-7">
                                <img src="image/precom/stdjpg.jpg" class="game-pic " width="140px">
                            </div>

                            <div class="col-md-4 col-sm-6 " style="padding-left:40px;">
                                <h3 class="thelast" style="text-transform: uppercase; font-weight:bold"> The Last of Us 2</h3>
                                <p style="font-size:12px;margin-left:4px;text-transform: uppercase; font-weight:bold;color: #164094;">Sortie le : 19 juin 2020 </p>
                                <select name="plateforme" class="form-control" style=" width:83%;text-align:left;height:50px " id="plateforme">             
                                              <option value="PS4" class="form-control">PS4</option>
                                          </select>
                            </div>
                            <div class="col-md-4 col-sm-6 part2" style="margin-top:20px; margin-bottom:20px;">
                               ...
                               if(!connexion()){
                                ...
                                $db = Database::connect();
                                $statement = $db -> query("SELECT id_pre FROM precommande WHERE name_pre='The Last of Us 2' AND id_user =".intval($_SESSION['auth']['id']))->fetch();
                                ...
                                echo '<button  type="button" class="btn btn-primary bot-btns disabled"><i class="fas fa-angle-double-right"></i>Deja precommandé</button>';
                                  ...
                                  <input type="hidden" name="nom_pre" id="nom_pre" value="The Last of Us 2">
                                  <input type="hidden" name="page" id="page" value="pre1.php">
                    ...
                    <div class="tab-pane std" id="tab2">
                        <div class="row" class="width:90%">
                            ...
                            <div class="col-md-4 col-sm-6 ">
                                <img src="image/precom/col.jpg" class="game-pic " width="240px">
                            </div>
                    ...
                    <div class="tab-pane std" id="tab3">
                        <div class="row" class="width:90%">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-7">
                                <img src="image/precom/spec.jpg" class="game-pic " width="140px">
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 part2" style="margin-top:20px; margin-bottom:20px;">
                                ...
                                <p style="text-align:right; margin-right:15%; margin-left:30px; text-transform: uppercase; font-weight:bold;font-size:11px ">BÉNÉFICIEZ<span style="color:#8c4ff6"> jusqu'à -6%</span> avec nos promotions !
                                    ...
                                    <button class="btn btn-primary bot-btns"><i class="fas fa-angle-double-right"></i> Je précommande</button>
                                    <button class="btn btn-primary bot-btns res-btn"><i class="fas fa-angle-double-right"></i> RÉSERVEZ, payez à la sortie</button>
